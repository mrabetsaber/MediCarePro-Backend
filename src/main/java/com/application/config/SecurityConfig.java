...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
	...
	protected void configure(HttpSecurity http) throws Exception 
	{
        http.csrf().disable().authorizeRequests().antMatchers("/authenticate")
                ...
                .permitAll() .antMatchers("/patient/search", "/patient/patientlist", "/patient/searchPatientsByNumTel", "/patient/addPatient")
                .permitAll() .antMatchers("/appointement/addAppointement", "/patient/patientlist", "/patient/searchPatientsByNumTel","/patient/verifyPatient","/documents/upload")
                .permitAll() .antMatchers("/documents/upload","/documents/download/**")
                .permitAll() .antMatchers("/reports/generate","/documents/download/**")
